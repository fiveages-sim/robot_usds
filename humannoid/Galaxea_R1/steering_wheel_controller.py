...
def compute(db: og.Database):
    ...
    # steer_joint1: origin xyz="0.21516 0.28 0.12375" - 右前方
    # steer_joint2: origin xyz="0.21516 -0.28 0.12375" - 右后方
    # steer_joint3: origin xyz="-0.28084 0 0.12375" - 左前方（中间）
    wheel_positions = np.array([
        [0.21516, 0.28],      # wheel1 (steer_joint1) - 右前方
        [0.21516, -0.28],     # wheel2 (steer_joint2) - 右后方
        [-0.28084, 0]         # wheel3 (steer_joint3) - 左前方
    ])
